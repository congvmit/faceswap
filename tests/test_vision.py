...
def before_all() -> None:
    ...
    subprocess.run(
        [
            ...
            "-vframes",
            "1",
            ".assets/examples/target-240p.jpg",
        ]
    )
    subprocess.run(
        [
            ...
            "-vframes",
            "1",
            ".assets/examples/target-1080p.jpg",
        ]
    )
    subprocess.run(
        [
            ...
            "-vf",
            "transpose=0",
            ".assets/examples/target-240p-90deg.jpg",
        ]
    )
    subprocess.run(
        [
            ...
            "-vf",
            "transpose=0",
            ".assets/examples/target-1080p-90deg.jpg",
        ]
    )
    subprocess.run(
        [
    ...
    subprocess.run(
        [
            ...
            "-vf",
            "transpose=0",
            ".assets/examples/target-240p-90deg.mp4",
        ]
    )
    subprocess.run(
        [
            ...
            "-vf",
            "transpose=0",
            ".assets/examples/target-1080p-90deg.mp4",
        ]
    )
...
def test_detect_image_resolution() -> None:
    ...
    assert detect_image_resolution(".assets/examples/target-240p-90deg.jpg") == (
        226,
        426,
    )
    assert detect_image_resolution(".assets/examples/target-1080p.jpg") == (2048, 1080)
    assert detect_image_resolution(".assets/examples/target-1080p-90deg.jpg") == (
        1080,
        2048,
    )
...
def test_restrict_image_resolution() -> None:
    assert restrict_image_resolution(
        ".assets/examples/target-1080p.jpg", (426, 226)
    ) == (426, 226)
    assert restrict_image_resolution(
        ".assets/examples/target-1080p.jpg", (2048, 1080)
    ) == (2048, 1080)
    assert restrict_image_resolution(
        ".assets/examples/target-1080p.jpg", (4096, 2160)
    ) == (2048, 1080)


def test_create_image_resolutions() -> None:
    assert create_image_resolutions((426, 226)) == [
        "106x56",
        "212x112",
        "320x170",
        "426x226",
    ...
    assert create_image_resolutions((226, 426)) == [
        "56x106",
        "112x212",
        "170x320",
        "226x426",
    ...
    assert create_image_resolutions((2048, 1080)) == [
        "512x270",
        "1024x540",
        "1536x810",
        "2048x1080",
    ...
    assert create_image_resolutions((1080, 2048)) == [
        "270x512",
        "540x1024",
        "810x1536",
        "1080x2048",
...
def test_detect_video_resolution() -> None:
    ...
    assert detect_video_resolution(".assets/examples/target-240p-90deg.mp4") == (
        226,
        426,
    )
    assert detect_video_resolution(".assets/examples/target-1080p.mp4") == (2048, 1080)
    assert detect_video_resolution(".assets/examples/target-1080p-90deg.mp4") == (
        1080,
        2048,
    )
...
def test_restrict_video_resolution() -> None:
    assert restrict_video_resolution(
        ".assets/examples/target-1080p.mp4", (426, 226)
    ) == (426, 226)
    assert restrict_video_resolution(
        ".assets/examples/target-1080p.mp4", (2048, 1080)
    ) == (2048, 1080)
    assert restrict_video_resolution(
        ".assets/examples/target-1080p.mp4", (4096, 2160)
    ) == (2048, 1080)


def test_create_video_resolutions() -> None:
    assert create_video_resolutions((426, 226)) == [
        "426x226",
        "452x240",
        "678x360",
        "904x480",
    ...
    assert create_video_resolutions((226, 426)) == [
        "226x426",
        "240x452",
        "360x678",
        "480x904",
    ...
    assert create_video_resolutions((2048, 1080)) == [
        "456x240",
        "682x360",
        "910x480",
        "1024x540",
    ...
    assert create_video_resolutions((1080, 2048)) == [
        "240x456",
        "360x682",
        "480x910",
        "540x1024",
