...
def test_has_audio() -> None:
    ...
    assert (
        has_audio([".assets/examples/source.mp3", ".assets/examples/source.jpg"])
        is True
    )
    assert (
        has_audio([".assets/examples/source.jpg", ".assets/examples/source.jpg"])
        is False
    )
...
def test_has_image() -> None:
    ...
    assert (
        has_image([".assets/examples/source.jpg", ".assets/examples/source.mp3"])
        is True
    )
    assert (
        has_image([".assets/examples/source.mp3", ".assets/examples/source.mp3"])
        is False
    )
...
def test_filter_audio_paths() -> None:
    assert filter_audio_paths(
        [".assets/examples/source.jpg", ".assets/examples/source.mp3"]
...
def test_filter_image_paths() -> None:
    ...
    assert (
        filter_image_paths(
            [".assets/examples/source.mp3", ".assets/examples/source.mp3"]
        )
        == []
    )
    assert filter_audio_paths(["invalid"]) == []
