...
def test_debug_face_to_image() -> None:
    commands = [
        ...
        ".assets/examples/target-240p.jpg",
        "-o",
        ".assets/examples/test_debug_face_to_image.jpg",
        "--headless",
    ]
...
def test_debug_face_to_video() -> None:
    commands = [
        ...
        ".assets/examples/target-240p.mp4",
        "-o",
        ".assets/examples/test_debug_face_to_video.mp4",
        "--trim-frame-end",
        "10",
        "--headless",
    ]
...
def test_enhance_face_to_image() -> None:
    commands = [
        ...
        ".assets/examples/target-240p.jpg",
        "-o",
        ".assets/examples/test_enhance_face_to_image.jpg",
        "--headless",
    ]
    run = subprocess.run(commands, stdout=subprocess.PIPE, stderr=subprocess.STDOUT)
...
def test_enhance_face_to_video() -> None:
    commands = [
        ...
        ".assets/examples/target-240p.mp4",
        "-o",
        ".assets/examples/test_enhance_face_to_video.mp4",
        "--trim-frame-end",
        "10",
        "--headless",
    ]
...
def test_swap_face_to_image() -> None:
    commands = [
        ...
        ".assets/examples/target-240p.jpg",
        "-o",
        ".assets/examples/test_swap_face_to_image.jpg",
        "--headless",
    ]
    run = subprocess.run(commands, stdout=subprocess.PIPE, stderr=subprocess.STDOUT)
...
def test_swap_face_to_video() -> None:
    commands = [
        ...
        ".assets/examples/target-240p.mp4",
        "-o",
        ".assets/examples/test_swap_face_to_video.mp4",
        "--trim-frame-end",
        "10",
        "--headless",
    ]
...
def test_sync_lip_to_image() -> None:
    commands = [
        ...
        "lip_syncer",
        "-s",
        ".assets/examples/source.mp3",
        "-t",
        ".assets/examples/target-240p.jpg",
        "-o",
        ".assets/examples/test_sync_lip_to_image.jpg",
        "--headless",
    ]
    run = subprocess.run(commands, stdout=subprocess.PIPE, stderr=subprocess.STDOUT)
...
def test_sync_lip_to_video() -> None:
    commands = [
        ...
        ".assets/examples/target-240p.mp4",
        "-o",
        ".assets/examples/test_sync_lip_to_video.mp4",
        "--trim-frame-end",
        "10",
        "--headless",
    ]
