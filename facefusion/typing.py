...
FaceRecognizerModel = Literal[
    "arcface_blendswap", "arcface_inswapper", "arcface_simswap", "arcface_uniface"
]
...
OptionsWithModel = TypedDict("OptionsWithModel", {"model": ModelValue})

ValueAndUnit = TypedDict("ValueAndUnit", {"value": str, "unit": str})
ExecutionDeviceFramework = TypedDict(
    "ExecutionDeviceFramework", {"name": str, "version": str}
)
...
ExecutionDeviceVideoMemory = TypedDict(
    "ExecutionDeviceVideoMemory", {"total": ValueAndUnit, "free": ValueAndUnit}
)
ExecutionDeviceUtilization = TypedDict(
    "ExecutionDeviceUtilization", {"gpu": ValueAndUnit, "memory": ValueAndUnit}
)
