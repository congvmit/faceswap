...
from facefusion.typing import FaceSelectorMode, VisionFrame
...
def render() -> None:
    ...
    REFERENCE_FACE_DISTANCE_SLIDER = gradio.Slider(
        ...
        step=facefusion.choices.reference_face_distance_range[1]
        - facefusion.choices.reference_face_distance_range[0],
...
def listen() -> None:
    ...
    for ui_component in get_ui_components(
        ["face_detector_model_dropdown", "face_detector_size_dropdown"]
    ):
        ui_component.change(
...
def clear_and_update_reference_face_position(
    event: gradio.SelectData,
) -> gradio.Gallery:
