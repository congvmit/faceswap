...
def render() -> None:
    ...
    EXECUTION_QUEUE_COUNT_SLIDER = gradio.Slider(
        ...
        step=facefusion.choices.execution_queue_count_range[1]
        - facefusion.choices.execution_queue_count_range[0],
...
def listen() -> None:
    EXECUTION_QUEUE_COUNT_SLIDER.release(
        update_execution_queue_count, inputs=EXECUTION_QUEUE_COUNT_SLIDER
    )
