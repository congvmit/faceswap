...
def render() -> None:
    ...
    EXECUTION_THREAD_COUNT_SLIDER = gradio.Slider(
        ...
        step=facefusion.choices.execution_thread_count_range[1]
        - facefusion.choices.execution_thread_count_range[0],
...
def listen() -> None:
    EXECUTION_THREAD_COUNT_SLIDER.release(
        update_execution_thread_count, inputs=EXECUTION_THREAD_COUNT_SLIDER
    )
