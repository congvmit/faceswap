...
face_enhancer_models: List[FaceEnhancerModel] = [
    "codeformer",
    "gfpgan_1.2",
    "gfpgan_1.3",
    "gfpgan_1.4",
...
face_swapper_models: List[FaceSwapperModel] = [
    "blendswap_256",
    "inswapper_128",
    "inswapper_128_fp16",
    "simswap_256",
...
frame_colorizer_models: List[FrameColorizerModel] = [
    "ddcolor",
    "ddcolor_artistic",
    "deoldify_artistic",
]
frame_enhancer_models: List[FrameEnhancerModel] = [
    "lsdir_x4",
    "nomos8k_sc_x4",
    "real_esrgan_x2",
    "real_esrgan_x2_fp16",
