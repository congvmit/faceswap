...
def cli() -> None:
    ...
    program.add_argument(
        "--onnxruntime",
        help=wording.get("help.install_dependency").format(dependency="onnxruntime"),
        choices=ONNXRUNTIMES.keys(),
    )
    program.add_argument(
        "--skip-conda", help=wording.get("help.skip_conda"), action="store_true"
    )
    program.add_argument(
        "-v",
        "--version",
    ...
    if args.onnxruntime:
        ...
        answers = inquirer.prompt(
            [
                inquirer.List(
                    "onnxruntime",
                    message=wording.get("help.install_dependency").format(
